...
Download and Install [Parallels Business](https://www.parallels.com/au/products/business/) or [Parallels Pro](https://www.parallels.com/au/products/desktop/pro/) on any one of the supported platforms:

 - Windows ARM hosts
 - OS ARM X hosts
 - Linux ARM distributions

Standart paralles doesn't work with Vagrant!!!
## Vagrant

Once Parallels is installed you may chose to deploy virtual machines manually on it.
Vagrant provides an easier way to deploy multiple virtual machines on Parallels more consistently.
...
The network used by the Parallels virtual machines is `192.168.56.0/24`.
